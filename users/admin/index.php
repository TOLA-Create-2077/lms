      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="card card-stats card-round small-box" style="overflow: hidden;">
            ...
            <a href="manage_users.php" style="background-color:  #aeababc7; display:flex;justify-content: center;align-items:center; color:white" class="small-box-footer p-1">ព័ត៌មានបន្ថែម &nbsp<i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
    </div>
