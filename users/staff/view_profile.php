...
include_once('../../include/session_staff.php');
...
<div class="container">
    <div class="page-inner">
        ...
        <div id="containerFunctionAdd">
            ...
            <a href="profileEdit.php?user_id=<?= urlencode($user_id); ?>" class="btn btn-warning text-white">
                <i class="fa-solid fa-pen-to-square"></i> កែប្រែប្រវត្តិរូប
            </a>
