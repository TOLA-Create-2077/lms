...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['user_id'])) {
        ...
        $department_id = $_POST['department_id']; // Capture the department ID
        ...
        if ($check_stmt->rowCount() > 0) {
            ...
            if ($image_url) {
                $sql = "UPDATE user_info SET first_name = :first_name, last_name = :last_name, username = :username, email = :email, phone_number = :phone_number, department_id = :department_id, image_url = :image_url WHERE user_id = :user_id";
            } else {
                $sql = "UPDATE user_info SET first_name = :first_name, last_name = :last_name, username = :username, email = :email, phone_number = :phone_number, department_id = :department_id WHERE user_id = :user_id";
            }
            ...
            $stmt->bindValue(':department_id', $department_id, PDO::PARAM_INT); // Bind department ID
